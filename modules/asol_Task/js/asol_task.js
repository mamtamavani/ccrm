			...
			+ "<div class='content' id='all'>"
                ...
                + "<table class='edit view'>"
                    ...
                    + "<tr>"
                        ...
                        + "<td>"
                            + "<input type='text' ondblclick='' onmouseover='this.title=this.innerHTML;' autocomplete='off' title='' value='' size='38' id='email_tpl_name' name='email_tpl_name' class='send_email_tpl_name' />"
                    ...
                    + "<tr>"
                        ...
                        + "<td>"
                            + "<input type='text' id='email_from' name='email_from' value='' class='send_email_from' onmouseover='this.title=this.innerHTML;' />"
                        + "</td>"
                    + "</tr>"
                    //to
                    + "<tr>"
                    ...
                    + "<tr>"
                        ...
                        + "<td>"
                            + "<input id='email_users_for_to_readonly' type='text' readonly='' class='send_email_summary' onmouseover='this.title=this.innerHTML;' />"
                        + "</td>"
                    + "</tr>"
                    + "<tr>"
                        + "<td>"+lbl_asol_task_js_send_email_roles+"</td>"
                        + "<td>"
                            + "<input id='email_roles_for_to_readonly' type='text' readonly='' class='send_email_summary' onmouseover='this.title=this.innerHTML;' />"
                        + "</td>"
                    + "</tr>"
                    + "<tr>"
                        + "<td>"+lbl_asol_task_js_send_email_notificationEmails+"</td>"
                        + "<td>"
                            + "<input id='email_notificationEmails_for_to_readonly' type='text' readonly='' class='send_email_summary' onmouseover='this.title=this.innerHTML;' />"
                        + "</td>"
                    + "</tr>"
                    + "<tr>"
                        + "<td>"+lbl_asol_task_js_send_email_distribution_list+":</td>"
                        + "<td>"
                            + "<textarea id='email_list_for_to_readonly' name='email_list_for_to' type='text' readonly='' class='send_email_summary' onmouseover='this.title=this.innerHTML;'></textarea>"
                        + "</td>"
                        + "<td colspan='2'></td>" 
                    + "</tr>"
                    //cc
                    ...
                    + "<tr>"
                        + "<td>"+lbl_asol_task_js_send_email_users+"</td>"
                        + "<td>"
                            + "<input id='email_users_for_cc_readonly' type='text' readonly='' class='send_email_summary' onmouseover='this.title=this.innerHTML;' />"
                        + "</td>"
                    + "</tr>"
                    + "<tr>"
                        + "<td>"+lbl_asol_task_js_send_email_roles+"</td>"
                        + "<td>"
                            + "<input id='email_roles_for_cc_readonly' type='text' readonly='' class='send_email_summary' onmouseover='this.title=this.innerHTML;' />"
                        + "</td>"
                    + "</tr>"
                    + "<tr>"
                        + "<td>"+lbl_asol_task_js_send_email_notificationEmails+"</td>"
                        + "<td>"
                            + "<input id='email_notificationEmails_for_cc_readonly' type='text' readonly='' class='send_email_summary' onmouseover='this.title=this.innerHTML;' />"
                        + "</td>"
                    + "</tr>"
                    + "<tr>"
                        + "<td>"+lbl_asol_task_js_send_email_distribution_list+":</td>"
                        + "<td>"
                            + "<textarea id='email_list_for_cc_readonly' name='email_list_for_to' type='text' readonly='' class='send_email_summary' onmouseover='this.title=this.innerHTML;' ></textarea>"
                        + "</td>"
                        + "<td colspan='2'></td>" 
                    + "</tr>"
                    //bcc
                    ...
                    + "<tr>"
                        + "<td>"+lbl_asol_task_js_send_email_users+"</td>"
                        + "<td>"
                            + "<input id='email_users_for_bcc_readonly' type='text' readonly='' class='send_email_summary' onmouseover='this.title=this.innerHTML;' />"+"</td>"
                    + "</tr>"
                    + "<tr>"
                        + "<td>"+lbl_asol_task_js_send_email_roles+"</td>"
                        + "<td>"
                            + "<input id='email_roles_for_bcc_readonly' type='text' readonly='' class='send_email_summary' onmouseover='this.title=this.innerHTML;' />"
                        + "</td>"
                    + "</tr>"
                    + "<tr>"
                        + "<td>"+lbl_asol_task_js_send_email_notificationEmails+"</td>"
                        + "<td>"
                            + "<input id='email_notificationEmails_for_bcc_readonly' type='text' readonly='' class='send_email_summary' onmouseover='this.title=this.innerHTML;' />"
                        + "</td>"
                    + "</tr>"
                    + "<tr>"
                        + "<td>"+lbl_asol_task_js_send_email_distribution_list+":</td>"
                        + "<td>"
                            + "<textarea id='email_list_for_bcc_readonly' name='email_list_for_to' type='text' readonly='' class='send_email_summary' onmouseover='this.title=this.innerHTML;' ></textarea>"
                        + "</td>"
                        + "<td colspan='2'></td>" 
                    + "</tr>"
                + "</table>"
		...
		document.getElementById("task_implementation.default").innerHTML += ""
			+ "<table class='edit view'>"
                ...
                + "<tr>"
                    ...
                    + "</td>"
                + "<tr>"
                     + "<td colspan='4'>"+lbl_asol_task_js_call_process_execute_subprocess_immediately+": <input type='checkbox' id='execute_subprocess_immediately' name='execute_subprocess_immediately'></td>"
                + "</tr>"
			+ "</table>"
		;
...
function remember_taskImplementation(taskType, implementationField) {
	...
	switch (taskType) {
		...
		case "call_process":
			...
			document.getElementById("process_id").value = implementationField_array[0];
			document.getElementById("process_name").value = implementationField_array[1];
			document.getElementById("event_id").value = implementationField_array[2];
			document.getElementById("event_name").value = implementationField_array[3];
			document.getElementById("execute_subprocess_immediately").checked = (implementationField_array[4] == "true") ? true : false;
...
function generate_BaseDate_HTML_and_Remember_DataBase_if_needed(rowIndex, value) {
    ...
    var cell_Value_HTML = "<input type='text' name='baseDate_"+rowIndex+"' id='baseDate_"+rowIndex+"' style='width:140px' value='"+unescape(value)+"' onmouseover='this.title=this.innerHTML;'>";
...
function generate_BaseDatetime_HTML_and_Remember_DataBase_if_needed(rowIndex, value) {
    ...
    var cell_Value_HTML = "<input type='text' name='baseDatetime_"+rowIndex+"' id='baseDatetime_"+rowIndex+"' style='width:140px' value='"+unescape(value)+"' onmouseover='this.title=this.innerHTML;'>";
...
function generate_Relate_Field_HTML_and_Remember_DataBase_if_needed(rowIndex, relateValuesString, relateModule) {
	...
	var cell_Value_HTML = 
		"<input type='text' autocomplete='off' title='' value='" + unescape(relateValues[1]) + "' size='' id='record_name_"+rowIndex+"' name='record_name_"+rowIndex+"' onmouseover='this.title=this.innerHTML;'>"
...
function generate_Default_Field_HTML_and_Remember_DataBase_if_needed(rowIndex, value) {
	...
	var cell_Value_HTML = "<input type='text' name='Param1_"+rowIndex+"' id='Param1_"+rowIndex+"' style='width:140px' value='"+unescape(value)+"' onmouseover='this.title=this.innerHTML;'>";
