...
if(SUGAR.themes.activeTab){var oldActive=document.getElementById(SUGAR.themes.activeTab+"_tab");oldActive.getElementsByTagName('tr')[0].getElementsByTagName('td')[0].className="otherTabLeft";oldActive.getElementsByTagName('tr')[0].getElementsByTagName('td')[1].className="otherTab";oldActive.getElementsByTagName('tr')[0].getElementsByTagName('td')[2].className="otherTabRight";}
var newActive=document.getElementById(mainTab+"_tab");newActive.getElementsByTagName('tr')[0].getElementsByTagName('td')[0].className="currentTabLeft";newActive.getElementsByTagName('tr')[0].getElementsByTagName('td')[1].className="currentTab";newActive.getElementsByTagName('tr')[0].getElementsByTagName('td')[2].className="currentTabRight";SUGAR.themes.activeTab=mainTab;};SUGAR.themes.updateMoreTab=function(tabName){var moreTab=document.getElementById(SUGAR.themes.moreTab+"_tab");if(moreTab==null)
return;if(SUGAR.themes.moreTabUrl==null){SUGAR.themes.moreTabUrl=moreTab.getElementsByTagName('tr')[0].getElementsByTagName('td')[1].getElementsByTagName('a')[0].href;}
...
SUGAR.themes.firstReset=function(){document.getElementById(SUGAR.themes.startTab+"_tab").getElementsByTagName('tr')[0].getElementsByTagName('td')[1].getElementsByTagName('a')[0].className='currentTablink';SUGAR.themes.resetTabs();}
