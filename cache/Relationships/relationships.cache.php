 ...
 $relationships = array (
  ...
  array (
    ...
    array (
      ...
      3 => 
      array (
        'name' => 'asol_project_contactsasol_project_ida',
        'type' => 'varchar',
        'len' => 36,
      ),
      4 => 
      array (
        'name' => 'asol_project_contactscontacts_idb',
        'type' => 'varchar',
        'len' => 36,
      ),
    ),
    ...
    array (
      ...
      1 => 
      array (
        'name' => 'asol_project_contacts_alt',
        'type' => 'alternate_key',
        'fields' => 
        array (
          0 => 'asol_project_contactsasol_project_ida',
          1 => 'asol_project_contactscontacts_idb',
        ),
      ),
    ),
    'lhs_module' => 'asol_Project',
  ...
  'tst01_testmodule001_modified_user' => 
  array (
    'name' => 'tst01_testmodule001_modified_user',
    'lhs_module' => 'Users',
    'lhs_table' => 'users',
    'lhs_key' => 'id',
    'rhs_module' => 'tst01_testmodule001',
    'rhs_table' => 'tst01_testmodule001',
    'rhs_key' => 'modified_user_id',
    'relationship_type' => 'one-to-many',
  ),
  'tst01_testmodule001_created_by' => 
  array (
    'name' => 'tst01_testmodule001_created_by',
    'lhs_module' => 'Users',
    'lhs_table' => 'users',
    'lhs_key' => 'id',
    'rhs_module' => 'tst01_testmodule001',
  ...
  'tst01_testmodule001_assigned_user' => 
  array (
    'name' => 'tst01_testmodule001_assigned_user',
    'lhs_module' => 'Users',
    'lhs_table' => 'users',
    'lhs_key' => 'id',
    'rhs_module' => 'tst01_testmodule001',
  ...
  'mtngs_meeting_summary_modified_user' => 
  array (
    'name' => 'mtngs_meeting_summary_modified_user',
    'lhs_module' => 'Users',
    'lhs_table' => 'users',
    'lhs_key' => 'id',
    'rhs_module' => 'mtngs_Meeting_Summary',
    'rhs_table' => 'mtngs_meeting_summary',
    'rhs_key' => 'modified_user_id',
    'relationship_type' => 'one-to-many',
  ),
  'mtngs_meeting_summary_created_by' => 
  array (
    'name' => 'mtngs_meeting_summary_created_by',
    'lhs_module' => 'Users',
    'lhs_table' => 'users',
    'lhs_key' => 'id',
    'rhs_module' => 'mtngs_Meeting_Summary',
  ...
  'mtngs_meeting_summary_assigned_user' => 
  array (
    'name' => 'mtngs_meeting_summary_assigned_user',
    'lhs_module' => 'Users',
    'lhs_table' => 'users',
    'lhs_key' => 'id',
    'rhs_module' => 'mtngs_Meeting_Summary',
