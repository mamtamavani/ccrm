...
class SugarApplication
{
	...
	function loadUser(){
		...
		$allowed_actions = (!empty($this->controller->allowed_actions)) ? $this->controller->allowed_actions : $allowed_actions = array('EmailVerificationSend','emailVerification','verifyauthenticationcode','Authenticate', 'Login', 'LoggedOut');
