...
//	alert('style is '+styleType +' and new style is '+newStyle)
	if(styleType == 'color'){
		document.getElementById('current_color_style').href = "themes/"+ SUGAR.themes.theme_name +"/colors."+newStyle+".css";
	}
	if(styleType == 'font'){
		font_el = document.getElementById('current_font_style');
		font_el.removeAttribute('href');
		font_el.setAttribute('href',"themes/"+ SUGAR.themes.theme_name +"/fonts."+newStyle+".css");		
		font_el.href = "themes/"+ SUGAR.themes.theme_name +"/fonts."+newStyle+".css";
	}
