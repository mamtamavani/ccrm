...
SUGAR.themes.updateSubTabs = function(mainTab, htmlTab){
	...
	if(SUGAR.themes.activeTab){
		...
		oldActive.getElementsByTagName('tr')[0].getElementsByTagName('a')[0].className = "otherTabLink";
	...
	newActive.getElementsByTagName('tr')[0].getElementsByTagName('a')[0].className = "currentTabLink";
